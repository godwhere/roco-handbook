# Catalog data attribution and license notice

Roco World Offline Handbook is an independent, non-commercial, unofficial project. It is not endorsed by the game publisher, BWIKI, Bilibili, or the upstream contributors.
...
The project froze explicit MediaWiki revisions, validated response identity and content hashes, safely parsed data-only Lua tables without executing Lua, preserved unknown source fields, applied evidence-bound identity and display mappings, normalized and cross-referenced records, and packaged the result as an offline SQLite Catalog. Those transformations are described in the source lock, build report, decision records, and implementation reports.

The transformed Catalog data and applicable data-derived material are distributed under CC BY-NC-SA 4.0. This statement does not relicense independently authored application code or third-party software; their licenses are recorded separately.

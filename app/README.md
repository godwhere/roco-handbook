...
The third bottom destination is Tools. It uses vertically stacked reference cards for Season archive, Feature handbook, Egg groups, Game descriptions, Event timeline, Outfit inspiration, and Personal library. Every route is functional from bundled contracts or the current offline stores. Game descriptions provide 54 source terms and related skill or feature links. Event timeline provides month and category filtering over 547 preserved activity occurrences. Outfit inspiration provides search, grade filtering, gender switching, acquisition details, and 110 source-backed outfits with 220 local previews.

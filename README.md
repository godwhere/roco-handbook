...
| 自动化验证 | 105 项 Python 测试、117 项 Flutter 测试、静态检查、格式检查和 GitHub Actions 离线持续集成 |
...
- 阶段 8 已完成正式 App 身份、中英文界面、离线图片与字体、图鉴与详情页重构、筛选、异色切换和七个工具入口，并已将新版 NRC Wiki 数据与图片作为发布前基线；应用商店截图需要在最终视觉确定后重新生成。
